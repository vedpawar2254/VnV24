      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="relative h-80 rounded-lg overflow-hidden flex items-end p-8  bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1594035918235-8b415a3a785c?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=800')" }}>
          ...
          <div className="relative z-10">
            <h3 className="text-3xl font-serif font-bold">The Monsoon Collection</h3>
            <p className="max-w-xs mt-2 mb-4">Experience the fresh scents of petrichor and blossoming florals.</p>
            <Link href="/shop/collections/monsoon" className="font-bold inline-flex items-center group">
        ...
        <div className="relative h-80 rounded-lg overflow-hidden flex items-end p-8 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1620916566398-39f168a2d0c1?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=800')" }}>
          <div className="absolute inset-0 bg-primary opacity-50"></div>
          <div className="relative z-10">
            <h3 className="text-3xl font-serif font-bold">Perfect for Gifting</h3>
            <p className="max-w-xs mt-2 mb-4">Find the perfect present for your loved ones, beautifully packaged.</p>
            <Link href="/shop/gifting" className="font-bold inline-flex items-center group">
